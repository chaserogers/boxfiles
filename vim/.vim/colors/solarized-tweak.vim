...
let colors_name = "solarized-tweak"
...
hi! Comment cterm=NONE gui=NONE,italic ctermfg=12 guifg=#EDB231 ctermbg=NONE guibg=NONE
hi! Constant cterm=NONE gui=NONE ctermfg=6 guifg=#cb4b16 ctermbg=NONE guibg=NONE
...
if get(g:, "solarized_visibility", "") == "high"
  ...
  hi! CursorLineNr cterm=NONE,bold gui=NONE,bold ctermfg=1 guifg=#dc322f ctermbg=7 guibg=NONE
...
elseif get(g:, "solarized_visibility", "") == "low"
  ...
  hi! CursorLineNr cterm=NONE,bold gui=NONE,bold ctermfg=12 guifg=#839496 ctermbg=7 guibg=NONE
...
hi! LineNr cterm=NONE gui=NONE ctermfg=12 guifg=#839496 ctermbg=NONE guibg=NONE
...
hi! rubyDefine ctermfg=0 guifg=#073642 ctermbg=15 guibg=#fdf6e3 cterm=NONE,bold gui=NONE
hi! rubyControl ctermfg=0 guifg=#073642 ctermbg=15 guibg=#fdf6e3 cterm=NONE,bold gui=NONE
hi! rubySymbol ctermfg=0 guifg=#2aa198 ctermbg=15 guibg=#fdf6e3 cterm=NONE,bold gui=NONE
