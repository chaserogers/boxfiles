...
let s:gray0     = ['#111111', 234]
let s:gray1     = ['#131922', 235]
let s:gray2     = ['#222c3d', 237]
let s:gray3     = ['#41516d', 243]
let s:gray4     = ['#9aa7bd', 248]
let s:grayred   = ['#211921', 248]
...
" Editor Highlights
call s:HL('ColorColumn',                    '',         s:grayred,    '')
...
call s:HL('StatusLineNC',                   s:gray2,    s:gray3,    '')
...
call s:HL('Error',                          s:red,      s:gray0,    '')
call s:HL('Todo',                           s:pink,     s:gray0,    '')
